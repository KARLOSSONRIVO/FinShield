            ...
            <Table>
                <TableHeader>
                    <TableRow className="hover:bg-transparent border-b border-border/50">
                        <TableHead className="px-6 py-4 text-black font-bold text-base">Timestamp</TableHead>
                        <TableHead className="px-6 py-4 text-black font-bold text-base">Actor</TableHead>
                        <TableHead className="px-6 py-4 text-black font-bold text-base text-center">Action</TableHead>
                        <TableHead className="px-6 py-4 text-black font-bold text-base text-center">Entity Type</TableHead>
                        <TableHead className="px-6 py-4 text-black font-bold text-base text-right">Entity ID</TableHead>
                    </TableRow>
                </TableHeader>
                <TableBody>
                    {logs.length === 0 ? (
