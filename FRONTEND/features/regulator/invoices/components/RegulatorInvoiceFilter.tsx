...
import { InvoiceStatusFilter, SortConfig } from "../hooks/useRegulatorInvoices"
import { Invoice } from "@/lib/types"

interface RegulatorInvoiceFilterAndSortProps {
...
export function RegulatorInvoiceFilter({
    statusFilter,
    onStatusFilterChange,
    sortConfig,
    onSortChange
}: RegulatorInvoiceFilterAndSortProps) {
