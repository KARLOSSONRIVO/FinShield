...
export function TopBar({ title, organizationName = "Auditor Role", userName = "Auditor User" }: TopBarProps) {
    return (
            ...
            <div className="flex items-center gap-4">
                            ...
                            {[1, 2].map((_, i) => (
                                <div key={i} className="p-4 border-b border-border last:border-0 hover:bg-muted/50 transition-colors cursor-pointer">
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                        You have been assigned to review Company {100 + i}.
                                    </p>
                                </div>
                            ))}
                        </div>
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end" className="w-56">
                        ...
                        <DropdownMenuSeparator />
                        <Link href="/admin/auditor/settings">
