            ...
            <Table>
                <TableHeader>
                    <TableRow className="hover:bg-transparent border-b border-border/50">
                        <TableHead className="w-[300px] px-6 py-4 text-black font-bold text-base">Employee Username</TableHead>
                        <TableHead className="px-6 py-4 text-black font-bold text-base">Email</TableHead>
                    ...
                    {employees.map((employee) => (
                        <TableRow key={employee._id} className="h-24 hover:bg-muted/30 transition-colors border-b border-border/50">
                            <TableCell className="px-6">
                                <span className="font-bold text-base text-black">{employee.username}</span>
                            </TableCell>
                            <TableCell className="px-6">
                                <span className="text-sm text-black font-medium">{employee.email}</span>
                            </TableCell>
